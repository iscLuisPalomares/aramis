...
namespace ComprasProject {
    public partial class LineasPorCotizarOscar : Form {
        public LineasPorCotizarOscar() {
            InitializeComponent();
        }
        ...
        public void getdata() {
            try {
                ...
                string sqlquery = "select fsid as 'ID', fsrequisicion as 'Requisicion', "
                    ...
                    + "where materialrequerido.fsstatus = 'Requisicion Aprobada' order by 'Fecha Aprobacion'";
