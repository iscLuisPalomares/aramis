...
namespace ComprasProject {
    public partial class MenuApAjuste : Form {
        public MenuApAjuste() {
            InitializeComponent();
        }
        ...
        private void btnajustescreados_Click(object sender, EventArgs e) {
            PendingApAjustes ap = new PendingApAjustes();
            ap.user_id = user_id;
            ap.usuario = usuario;
            ap.depto = user_depto;
        ...
        private void pbcotizacion_Click(object sender, EventArgs e) {
            LineasPorCotizarOscar lt = new LineasPorCotizarOscar();
            lt.usuario = usuario;
            lt.user_id = user_id;
            lt.FormClosed += Lt_FormClosed;
            Visible = false;
