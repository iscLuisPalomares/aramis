...
namespace ComprasProject {
    public partial class MenuCompras : Form {
        ...
        private void pbrequi_Click(object sender, EventArgs e) {
            ...
            cr.gerenteid = gerenteid;
            cr.tipo = tipo;
            cr.FormClosed += Cr_FormClosed1; ;
            Visible = false;
            cr.ShowDialog();
        }
        private void Cr_FormClosed1(object sender, FormClosedEventArgs e) {
            Visible = true;
        }
        private void pbsku_Click(object sender, EventArgs e) {
            SKU sk = new SKU();
            sk.usuario = usuario;
            sk.tipo = tipo;
            sk.user_id = user_id;
            sk.user_depto = user_depto;
            sk.FormClosed += Sk_FormClosed1; ;
            Visible = false;
            sk.ShowDialog();
        }
        private void Sk_FormClosed1(object sender, FormClosedEventArgs e) {
            Visible = true;
        }
        private void pbsuppliers_Click(object sender, EventArgs e) {
            ...
            ca.user_id = user_id;
            ca.user_depto = user_depto;
            ca.FormClosed += Ca_FormClosed2; ;
            Visible = false;
            ca.ShowDialog();
        }
        private void Ca_FormClosed2(object sender, FormClosedEventArgs e) {
            Visible = true;
        }
        private void pictureBox1_Click_2(object sender, EventArgs e) {
            RecibosPOBuyer rb = new RecibosPOBuyer();
            rb.user_id = user_id;
            rb.usuario = usuario;
            rb.FormClosed += Rb_FormClosed;
            Visible = false;
            rb.ShowDialog();
        }
        private void Rb_FormClosed(object sender, FormClosedEventArgs e) {
            Visible = true;
        }
        private void pictureBox2_Click_1(object sender, EventArgs e) {
            PendingCotizacionesC pcc = new PendingCotizacionesC();
            pcc.user_id = user_id;
            pcc.usuario = usuario;
            pcc.tipo = tipo;
            Visible = false;
            pcc.FormClosed += Pcc_FormClosed;
            pcc.ShowDialog();
        }
        private void Pcc_FormClosed(object sender, FormClosedEventArgs e) {
            Visible = true;
        }
